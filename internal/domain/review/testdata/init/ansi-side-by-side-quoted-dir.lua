...
local plugin = "/Users/dev/My \"Data\" (é)/lyna-tmux/review/codediff.nvim"
local system = {}
...
local ok, err = pcall(function()
  require("codediff").setup({
    highlights = {
      ...
      char_insert = "#005c00",
      char_delete = "#5c0000",
      conflict_sign = "#cdcd00",
      conflict_sign_resolved = "#e5e5e5",
      conflict_sign_accepted = "#00cd00",
      conflict_sign_rejected = "#cd0000",
    },
    diff = {
      layout = "side-by-side",
      filler_text = "╱",
