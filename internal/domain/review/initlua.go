...
const initHeader = `-- Generated by lyna-tmux for "lyna-tmux review". It is rewritten before a
...
vim.o.statusline = " %{v:lua.` + LabelFunc + `(bufname())} %{&modified ? '[+]' : ''}%=%l:%c  %P "
