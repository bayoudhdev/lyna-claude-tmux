	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for _, name := range Names() {
				...
				for kind, fragments := range tc.wantText {
...
func checkPreviewSpans(t *testing.T, p Palette, lines []Line) {
	t.Helper()
