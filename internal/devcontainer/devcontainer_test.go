...
func TestRenderRejects(t *testing.T) {
	cases := []struct {
		...
		{"version without v", Options{Project: "p", Source: Source{Version: "1.2.3"}}, "invalid lmux version"},
		{"version injection", Options{Project: "p", Source: Source{Version: "v1.2.3 && id"}}, "invalid lmux version"},
